...
import { emailVerificationSchema, sendCodeEmailVerificationSchema } from "../validations/email-verification.validation";
...
authRouter.post(
  "/register",
  /*authSensitiveLimiter ,*/ validate(registerSchema),
  register,
);

authRouter.post(
  "/login",
  /*authSensitiveLimiter,*/ validate(loginSchema),
  login,
);
...
authRouter.post("/send-code-email-verification", validate(sendCodeEmailVerificationSchema),sendCodeEmailVerification);

authRouter.patch("/email-verification", validate(emailVerificationSchema), emailVerification);
